...
CREATE TABLE orders (`drink` varchar(255) NOT NULL,`milk` varchar(255) NOT NULL,`size` varchar(255) DEFAULT NULL,`total` varchar(255) NOT NULL,`register` varchar(255) DEFAULT NULL,`status` varchar(255) NOT NULL); ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
